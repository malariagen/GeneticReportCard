...
public class ThreadedTaskManager {
	...
	public ThreadedTaskManager () {
		this(DEFAULT_THREAD_COUNT);
	}
	
	public ThreadedTaskManager (int threadCount){
	...
	private class ParallelExecutableThread extends Thread {
		private ThreadedTaskManager mgr;
		public ParallelExecutableThread (ThreadedTaskManager mgr) {
			this.mgr = mgr;
		}
